...
namespace forma
{
    ...
    struct Node
    {
        ...
        virtual node::Text* AsText() { return nullptr; }
        virtual node::Attribute* AsAttribute() { return nullptr; }
        virtual node::Iterate* AsIterate() { return nullptr; }
        virtual node::If* AsIf() { return nullptr; }
        virtual node::FunctionCall* AsFunctionCall() { return nullptr; }
        virtual node::Group* AsGroup() { return nullptr; }
    };
